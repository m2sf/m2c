...
PROD(COMPILATION_UNIT, compilationUnit,
  (TOKEN_INTERFACE, TOKEN_IMPLEMENTATION, TOKEN_MODULE, 0),
  (TOKEN_EOF, 0)
)
PROD(INTERFACE_MODULE, interfaceModule,
  (TOKEN_INTERFACE, 0),
  (TOKEN_EOF, 0)
)
PROD(IMPORT, import,
...
PROD(CONST_EXPRESSION, constExpression,
  (TOKEN_WHOLE_NUMBER, TOKEN_REAL_NUMBER, TOKEN_CHAR_CODE, TOKEN_QUOTED_STRING,
   TOKEN_IDENT, TOKEN_NOT, TOKEN_LBRACE, TOKEN_LPAREN, TOKEN_ASTERISK,
   TOKEN_SOLIDUS, TOKEN_DIV, TOKEN_MOD, TOKEN_AND, TOKEN_MINUS, 0),
...
PROD(QUALIDENT, qualident,
  ...
  TOKEN_LBRACKET, TOKEN_WILDCARD, TOKEN_DEREF, TOKEN_DO, TOKEN_END, 0)
)
...
PROD(SIMPLE_FACTOR, simpleFactor,
  (TOKEN_WHOLE_NUMBER, TOKEN_REAL_NUMBER, TOKEN_CHAR_CODE,
   TOKEN_QUOTED_STRING, TOKEN_LBRACE, TOKEN_IDENT, TOKEN_LPAREN, 0),
  (TOKEN_TYPE_CONV, TOKEN_COMMA, TOKEN_COLON, TOKEN_SEMICOLON, TOKEN_DOT_DOT,
